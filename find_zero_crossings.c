...
if( num_periods > 0)
	...
	{
	ave_period = BIG_POS_NUM;
	ave_ontime = BIG_POS_NUM;

	pzc_stats->num_periods = num_periods;
	pzc_stats->ave_period = ave_period;
	pzc_stats->ave_ontime = ave_ontime;
	
	pzc_stats->min_period = BIG_POS_NUM;
	pzc_stats->min_period_time = 0.0;
	pzc_stats->max_period = BIG_POS_NUM;
	pzc_stats->max_period_time = 0.0;
	
	pzc_stats->min_ontime = BIG_POS_NUM;
	pzc_stats->min_ontime_time = 0.0;
	pzc_stats->max_ontime = BIG_POS_NUM;
	pzc_stats->max_ontime_time = 0.0;
	}
return EXIT_SUCCESS;
}